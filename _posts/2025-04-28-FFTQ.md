...
$\omega_p $ : The angular velocity of the ${p}^{th}$ propeller
 ...
 $$
S(f) = \bar{A} \cdot \delta\left(f - \frac{2v}{\lambda} \right)
+ \sum_{p,q,m} \bar{B}_{pq} C_{pq}^m \cdot \delta\left(f - \frac{2v}{\lambda} - \frac{m \omega_p}{2\pi} \right)
$$
